...
def main():
    ...
    if rad=='Home':
        ...
        st.markdown("I am creating this Web Application to express my interest in the ML/DL and AI.Previously, I have an internship experience of 3 months at GOJEK where I have worked as a data Scientist and of 1 month as a data analyist for Henry Harvin analytics. I have also secured 2nd position in a Hackathon conducted by the Tredence Analytics.I’ve worked on ML projects like food preparation time estimation, Financial Analytics Loan Approval Prediction, and Analysing the Attrition Rate of a Company and DL projects like creating Question-Answering application, Text classification using LLMs, medical image classification, object detection. I am final year under graduation student at IIT Bhubaneswar. Apart from this, I enjoy playing football and have an interest in the stock market. With the right opportunities and experience working with prominent clients, I believe that I can achieve my goal.I would like the opportunity to meet with you and discuss the opportunities you have available. Please let me know if you have any questions or would like to see specific work samples.")
